...
CONFIG_LWIP ?= $(lwip)
CONFIG_BALLOON ?= n
CONFIG_APP_HEADLIGHT ?= n
CONFIG_APP_SENSOR ?= n
CONFIG_APP_GPIO_EVAL ?= n
CONFIG_APP_CANRTT_EVAL ?= y
CONFIG_APP_CANRTT_INTER ?= n
CONFIG_APP_LOADVM ?= n
CONFIG_APP_ECHO_SERVER ?= n
CONFIG_APP_XS_BENCH ?= n
CONFIG_APP_XS_BENCH_W ?= n
CONFIG_APP_XS_BENCH_R ?= n
CONFIG_APP_DRIVERTEST ?= n
...
DEFINES-$(CONFIG_VCANFRONT) += -DCONFIG_VCANFRONT
...
DEFINES-$(CONFIG_APP_HEADLIGHT) += -DCONFIG_APP_HEADLIGHT
DEFINES-$(CONFIG_APP_SENSOR) += -DCONFIG_APP_SENSOR
DEFINES-$(CONFIG_APP_GPIO_EVAL) += -DCONFIG_APP_GPIO_EVAL
DEFINES-$(CONFIG_APP_CANRTT_EVAL) += -DCONFIG_APP_CANRTT_EVAL
DEFINES-$(CONFIG_APP_CANRTT_INTER) += -DCONFIG_APP_CANRTT_INTER
DEFINES-$(CONFIG_APP_LOADVM) += -DCONFIG_APP_LOADVM
DEFINES-$(CONFIG_APP_ECHO_SERVER) += -DCONFIG_APP_ECHO_SERVER
DEFINES-$(CONFIG_APP_XS_BENCH) += -DCONFIG_APP_XS_BENCH
DEFINES-$(CONFIG_APP_XS_BENCH_W) += -DCONFIG_APP_XS_BENCH_W
DEFINES-$(CONFIG_APP_XS_BENCH_R) += -DCONFIG_APP_XS_BENCH_R
DEFINES-$(CONFIG_APP_DRIVERTEST) += -DCONFIG_APP_DRIVERTEST

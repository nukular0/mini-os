...
src-$(CONFIG_VGPIOFRONT) += vgpiofront.c
src-$(CONFIG_VCANFRONT) += vcanfront.c
#~ src-y += drivertest.c
#~ src-y += cantest.c
#~ src-y += sensorvm.c
src-$(CONFIG_APP_SENSOR) += sensorvm.c
src-$(CONFIG_APP_HEADLIGHT) += headlightvm.c
src-$(CONFIG_APP_GPIO_EVAL) += gpio_eval.c
src-$(CONFIG_APP_CANRTT_EVAL) += can_rtt_bench.c
src-$(CONFIG_APP_CANRTT_INTER) += can_rtt_bench_inter_vm.c
src-$(CONFIG_APP_LOADVM) += load_vm.c
src-$(CONFIG_APP_ECHO_SERVER) += udp_server.c
src-$(CONFIG_APP_XS_BENCH) += xenstore_bench.c
src-$(CONFIG_APP_XS_BENCH_W) += xenstore_bench_writer.c
src-$(CONFIG_APP_XS_BENCH_R) += xenstore_bench_reader.c
src-$(CONFIG_APP_DRIVERTEST) += drivertest.c
#~ src-y += udp_server_event.c
#~ src-y += xenstore_latency_benchmark.c
#src-y += daytime.c
#~ src-y += udpecho.c
src-y += events.c
